 ...
 * 
 * <p>This service provides local access to user operations within the
 * banking-interface application. It's used by REST API endpoints and
 * web controllers that run in the same JVM.</p>
 * 
 * <p>All operations are transactional and include proper validation and

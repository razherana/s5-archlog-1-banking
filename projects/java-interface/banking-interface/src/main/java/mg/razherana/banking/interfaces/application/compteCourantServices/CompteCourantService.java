...
public interface CompteCourantService {
   ...
   * @param actionDateTime The creation date/time (optional, defaults to current
   *                       time)
   ...
   * @param actionDateTime The action date/time (optional, defaults to current
   *                       time)
   * @param currency       The currency for the transaction (defaults to MGA if
   *                       null)
   * @return The created transaction or null if failed
   */
  TransactionCourant makeDeposit(UserAdmin userAdmin, Integer accountId, BigDecimal montant, String description,
      LocalDateTime actionDateTime, String currency);
   ...
   * @return The created transaction or null if failed
   */
  TransactionCourant makeWithdrawal(UserAdmin userAdmin, Integer accountId, BigDecimal montant, String description,
      LocalDateTime actionDateTime, String currency);
   ...
   * @param description          The transaction description
   * @param actionDateTime       The action date/time (optional, defaults to
   *                             current time)
   * @param currency             The currency for the transaction (defaults to MGA
   *                             if null)

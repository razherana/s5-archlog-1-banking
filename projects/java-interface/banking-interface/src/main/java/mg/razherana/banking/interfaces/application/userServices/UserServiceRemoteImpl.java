 ...
 * 
 * <p>This service provides remote access to user operations for other
 * Java applications (like java-courant, java-depot, java-pret).
 * It delegates to the local implementation to avoid code duplication.</p>
 * 
 * <p>Remote calls require serialization and are used for inter-application
 * communication. This implementation acts as a facade for the local service.</p>
 * 

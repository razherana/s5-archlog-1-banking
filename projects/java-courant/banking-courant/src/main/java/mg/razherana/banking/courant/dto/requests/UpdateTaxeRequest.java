 ...
 * 
 * <p>
 * Used to modify the monthly tax rate that is charged to an account.
 * The new tax amount will be used for calculating future tax obligations.
 * </p>
 * 
 ...
 * @see mg.razherana.banking.courant.api.CompteCourantResource#updateTaxe(Integer,
 *      UpdateTaxeRequest)
 * @see mg.razherana.banking.courant.application.compteCourantService.CompteCourantService#updateTaxe(Integer,
 *      BigDecimal)
 */

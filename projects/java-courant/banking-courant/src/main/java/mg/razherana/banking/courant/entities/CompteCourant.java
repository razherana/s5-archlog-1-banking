...
/**
 * Current account (Compte Courant) entity representing bank accounts in the system.
 * 
 * <p>This entity represents current accounts that belong to users. The account has
 * no stored balance field - the balance is calculated dynamically by summing all
 * transactions where the account is involved as sender or receiver.</p>
 * 
 * <p>Each account has a monthly tax that accumulates over time and must be paid
 * before performing withdrawals or transfers.</p>
 * 

 ...
 * 
 * <p>
 * Represents a tax payment operation where accumulated monthly taxes
 * are paid from an account. The tax amount is calculated automatically
 * based on the account's creation date and monthly tax rate.
 * </p>
 * 
 * <p>
 * Tax payments are required before performing withdrawals or transfers
 * on accounts that have unpaid taxes.
 * </p>
 * 
 ...
 * @see mg.razherana.banking.courant.application.transactionService.TransactionService#payTax(Integer,
 *      LocalDateTime)
 */

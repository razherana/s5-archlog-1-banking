 ...
 * 
 * <p>Represents a deposit operation where external money is added to an account.
 * In the transaction model, deposits have no sender (external source) and the
 * specified account as receiver.</p>
 * 
 ...
 * @see mg.razherana.banking.courant.application.TransactionService#depot(Integer, BigDecimal)
 */
